...
import {
  ...
  type SetThreadWorkflowLaneInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    setWorkflowLane: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:set-workflow-lane",
      execute: (input: SetThreadWorkflowLaneInput) => setThreadWorkflowLane(input),
      scheduler,
      concurrency,
    }),
