 ...
 * not follow it to another device — whereas the lane is a property of the work
 * and lives on the session (`thread.workflowLane`). Keeping the two in
 * different places is the point, not an oversight.
 *
