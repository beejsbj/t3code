import {
  ...
  ThreadWorkflowLaneSetPayload as ContractsThreadWorkflowLaneSetPayloadSchema,
...
export const ThreadWorkflowLaneSetPayload = ContractsThreadWorkflowLaneSetPayloadSchema;
